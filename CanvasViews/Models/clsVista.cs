...
namespace CanvasViews.Models
{
	public class clsVista
	{
		...
		CadenaConexion = "Server=frameworkanaliticavisual.database.windows.net;Initial Catalog=frameworkanaliticavisual;Persist Security Info=False;User ID=frameworkanaliticavisual;Password=Seminario123;MultipleActiveResultSets=False;TrustServerCertificate=False;Connection Timeout=30;";
		cargarVista1();
		cargarVista2();
		cargarVista3();
		}
		...
		dt.Columns.Add(column);
		DataRow newRow1 = dt.NewRow();
		newRow1["Tabla"] = "contacto";
		newRow1["Columna"] = "id_persona";
