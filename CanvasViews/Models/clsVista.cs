...
namespace CanvasViews.Models
{
    public class clsVista
    {
        ...
        public clsVista()
        {
            ...
            TablaPrincipal = "carrera";
            CadenaConexion = "Server=tcp:frameworkanaliticavisual.database.windows.net;Initial Catalog=frameworkanaliticavisual;Persist Security Info=False;User ID=frameworkanaliticavisual;Password=Seminario123;MultipleActiveResultSets=False;TrustServerCertificate=False;Connection Timeout=30;";
            cargarVista1();
            cargarVista2();
        }
