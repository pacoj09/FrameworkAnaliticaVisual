        ...
        <ContentTemplate>
            <asp:Wizard ID="Wizard1" runat="server" ActiveStepIndex="1" DisplaySideBar="False">
                ...
                <StartNavigationTemplate>
                    <br />
                    <asp:Button ID="StartNextButton" class="btn btn-default" runat="server" CommandName="MoveNext" Text="Siguiente" Enabled="false" OnClick="StartNextButton_Click" />
                </StartNavigationTemplate>
                <StepNavigationTemplate>
                    <asp:Button ID="StepPreviousButton" runat="server" CausesValidation="False" CommandName="MovePrevious" Text="Anterior" />
                    <asp:Button ID="StepNextButton" runat="server" CommandName="MoveNext" Text="Siguiente" Enabled="false" />
                </StepNavigationTemplate>
                <WizardSteps>
                    <asp:WizardStep ID="WizardStep1" runat="server" Title="Conexión a la base de datos">
                        <div align="center">
                            ...
                            <fieldset>
                                ...
                                <br>
                                <br>
                                <asp:Button ID="btnProbarConexion" class="btn btn-default" runat="server" Text="Probar Conexion" OnClick="btnProbarConexion_Click" OnClientClick="return ValidarFormulario()" />
                            </fieldset>
                            <br />
                            <br />
                    ...
                    <asp:WizardStep ID="WizardStep2" runat="server" Title="Selección de tablas">
                        <div align="center">
                            ...
                            <fieldset>
                                ...
                                <asp:Button ID="btnEstablecerTablaPrincipal" runat="server" Text="Establecer Tabla Principal" OnClick="btnEstablecerTablaPrincipal_Click" /><br />
                                <br />
                                <asp:Panel ID="pNuevaTabla" runat="server"></asp:Panel><br />
                                <asp:Button ID="btnAgregarTabla" runat="server" Text="Agregar Nueva Tabla" OnClick="btnAgregarTabla_Click" />
                            </fieldset>
                            <br />
                            <br />
                            <p>
